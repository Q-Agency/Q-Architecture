...
mixin SimpleNotifierController {
  late final Ref _ref;
...
abstract class SimpleNotifier<T> extends Notifier<T>
    with SimpleNotifierController {}

abstract class AutoDisposeSimpleNotifier<T> extends AutoDisposeNotifier<T>
    with SimpleNotifierController {}

abstract class FamilySimpleNotifier<T, Param> extends FamilyNotifier<T, Param>
    with SimpleNotifierController {}

abstract class AutoDisposeFamilySimpleNotifier<T, Param>
    extends AutoDisposeFamilyNotifier<T, Param> with SimpleNotifierController {}
